...
Note: These data are provided temporarily via Box and will be archived in a permanent repository upon publication.
...
## Using the Application (Single Gene)
...
3. GO Enrichment Analysis Plots of Correlated Genes
   - With optional filters and parameters to tailor your experience
...
## Using the Application (Batch)

1. Upload a file with genes listed, one per line

2. Adjust filtering and output parameters
...
Downloading Files Gives:

1. Heatmaps for each gene

2. UMAP Plots for each gene top hits

3. Correlation Tables for each gene

4. Summary Table with:
    - top correlated enrichments
    - top correlated genes
    - mean, min, and max correlation
    - pvalues for correlation
...
If you use this software or results generated by it before formal publication, please cite the underlying data source:
...
I would appreciate your acknowledgment of the Gene Correlation Explorer in presentations or derivative analyses.

------------------------------------------------------------

## Questions and Issues

For questions, issues, or suggestions, don't hesitate to contact the authors or open an issue in the repository.
